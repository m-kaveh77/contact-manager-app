            ...
            <div className="col-md-7 col-sm-7">
              <ul className="list-group">
                <li className="list-group-item list-group-item-dark">
                  نام و نام خانوادگی: <span className="fw-bold">محسن کاوه</span>
                </li>

                <li className="list-group-item list-group-item-dark">
                  شماره موبایل: <span className="fw-bold">09393780066</span>
                </li>

                <li className="list-group-item list-group-item-dark">
                  آدرس ایمیل:{" "}
                  <span className="fw-bold">mohsenkaveh18@gmail.com</span>
                </li>
              </ul>
            </div>
